import{_ as n,c as s,a,o as l}from"./app-CjvLLpCW.js";const i={};function t(r,e){return l(),s("div",null,e[0]||(e[0]=[a(`<h1 id="element-小技巧" tabindex="-1"><a class="header-anchor" href="#element-小技巧"><span>element 小技巧</span></a></h1><h3 id="_1-el-table-表格内容超出省略" tabindex="-1"><a class="header-anchor" href="#_1-el-table-表格内容超出省略"><span>1.el-table 表格内容超出省略</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">当表格内容过长时，手动添加样式比较麻烦，偷偷告诉你，只需要添加一个 show-overflow-tooltip 就可以搞定。</span>
