import{_ as n,c as e,a,o as i}from"./app-CjvLLpCW.js";const l={};function t(c,s){return i(),e("div",null,s[0]||(s[0]=[a(`<h1 id="_011-vue生命周期的钩子如何实现的" tabindex="-1"><a class="header-anchor" href="#_011-vue生命周期的钩子如何实现的"><span>011-vue生命周期的钩子如何实现的</span></a></h1><h2 id="生命周期钩子是如何实现的" tabindex="-1"><a class="header-anchor" href="#生命周期钩子是如何实现的"><span>生命周期钩子是如何实现的</span></a></h2><p>Vue 的生命周期钩子核心实现是利用发布订阅模式先把用户传入的的生命周期钩子订阅好（内部采用数组的方式存储）然后在创建组件实例的过程中会一次执行对应的钩子方法（发布） 相关代码如下</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">export function callHook(vm, hook) {</span>
