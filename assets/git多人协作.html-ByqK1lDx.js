import{_ as s,c as n,a,o as i}from"./app-CjvLLpCW.js";const l={};function t(r,e){return i(),n("div",null,e[0]||(e[0]=[a(`<h1 id="git多人协作" tabindex="-1"><a class="header-anchor" href="#git多人协作"><span>git多人协作</span></a></h1><p>图形化工具有很多，我们下载后直接用就行，现在我们主要说一下命令行的git 的使用。</p><p>下面我们说一下，在工作常见的多人协作使用命令行场景：</p><blockquote><p>假设现在有三个人，A，B都是开发，C是负责人。 任务需求到达，A来开发登录板块。B来开发注册板块。</p></blockquote><p><strong>1</strong> A 首先把git 项目克隆到本地，（就一开始没有项目时候使用一次即可）</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">git clone http//XXX</span>
