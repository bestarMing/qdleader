import{_ as n,c as a,a as e,o as l}from"./app-CjvLLpCW.js";const i={};function u(p,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h1 id="y004-隐式转换2" tabindex="-1"><a class="header-anchor" href="#y004-隐式转换2"><span>Y004-隐式转换2</span></a></h1><p>Javascript 隐式强制类型转换</p><p>这里直接上各种类型之间的转换结果，如果没有明白，那就带着问题往下读。</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">❞</span>
