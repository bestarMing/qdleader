import{_ as e,c as n,a,o as i}from"./app-CjvLLpCW.js";const l={};function d(r,s){return i(),n("div",null,s[0]||(s[0]=[a(`<h1 id="linux常用命令" tabindex="-1"><a class="header-anchor" href="#linux常用命令"><span>linux常用命令</span></a></h1><h2 id="进入文件" tabindex="-1"><a class="header-anchor" href="#进入文件"><span>进入文件</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">cd /home 进入 &#39;/ home&#39; 目录&#39;</span>
